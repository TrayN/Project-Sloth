package classes;
    ...
    public static BufferedImage getScreenshot(WinDef.HWND windowHandle, Rectangle bounds) {
        WinDef.HDC windowDC = GDI.GetDC(windowHandle);//"triuiScreen", "EVE - Dart Shikari"));
    ...
    private static BufferedImage bufferedImageFromBitmap(WinDef.HDC blitDC, WinDef.HBITMAP outputBitmap, WinGDI.BITMAPINFO bi) {
        ...
        switch (bih.biBitCount) {
            case 16:    strideElementsAligned = strideBytesAligned / 2;
                        ...
                        break;
            case 32:    strideElementsAligned = strideBytesAligned / 4;
